...
from jsclub.account import views
from django.contrib import admin


urlpatterns = [

    # move Urls from jsclub/urls.py to account/urls.py
    ...
    url(r'^settings/password/$', auth_views.PasswordChangeView.as_view(template_name='templates/password_change.html'),
